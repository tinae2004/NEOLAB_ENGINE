...
# =========================================================
# 0. BULLETPROOF CLI LOCATOR & INSTALLER (MISTRALAI PURGED)
# =========================================================
...
load_dotenv()
app = FastAPI(title="NEO LAB Engine", version="10.2 (Master Tunnel - Purged Edition)")
