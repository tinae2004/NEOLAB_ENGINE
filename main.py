...
# =========================================================
# NEO LAB ENGINE v8.3
# THE MASTER LOCK (BASE64 + TITANIUM TUNNEL)
# =========================================================
...
load_dotenv()
app = FastAPI(title="NEO LAB ENGINE", version="8.3")
...
# =========================================================
# IMMORTAL NEOX TUNNEL (BASE64 + DEEP LOGGING)
# =========================================================
...
async def websocket_terminal(websocket: WebSocket, user_id: str = "user_001"):
    ...
    try:
        ...
        if mode == "beginner":
            ...
            # 🚨 THE BASE64 KEY UNPACKER
            b64_key_data = os.environ.get("NEOX_PRIVATE_KEY_B64")
            if not b64_key_data:
                await websocket.send_text("\r\n\033[31m[CRITICAL] NEOX_PRIVATE_KEY_B64 missing from Render Environment!\033[0m\r\n")
                return
                
            try:
                raw_pem_bytes = base64.b64decode(b64_key_data)
